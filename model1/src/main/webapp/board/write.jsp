							...
							<div class="card card-primary card-outline mb-4">
								...
								<form id="form1">
									<div class="card-body">
										...
										<div class="mb-3">
											<input type="text" class="form-control" placeholder="제목입력하세요.." name="title"/>
										</div>
										...
										<div class="mb-3">
											<textarea type="text" class="form-control" id="editor" placeholder="내용을 입력하세요.." name="content" /></textarea>
										</div>
