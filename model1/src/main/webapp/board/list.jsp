				...
				<div class="card mb-4">
                  ...
                  <div class="card-body p-0">
                    <table class="table" role="table">
                      ...
                      <tbody>
                      <%//List는 배열과 거의 같으므로, for문을 이용하여 0부터 시작하는 루프를 시용하자 %>
                      <%for %>>
                      	<%while(rs.next()){%>
                        <tr class="align-middle">
                          <td>1.</td>
                          <!-- POST 방식만이 서버에 데이터를 전송할 수 있는 것은 아니다..
                          	즉 Get 방식도 소량의 데이터는 서버에 데이터를 전송할 수 있는데, 이때 물음표 뒤에 
                          	parameter=value&parameter=value&parameter=value
                          	content.jsp?board_id=3
                           -->
  	...
  	<script type="text/javascript">
	  	$(function(){
			...
			$("#bt_write").click(function(){
				// location.href="/board/write.jsp";  // 순수  js 코드 이용하는 방법
